...
// m = 2, n = 3 -> A(m,n) = 9   А=(2-1,А(2,3-1))=1,А(2,2)
// m = 3, n = 2 -> A(m,n) = 29
...
if (m < 0 || n < 0) System.Console.WriteLine($"Одно или оба числа меньше 0, введите положительные числа");
if (m >= 0 && n >=0) System.Console.WriteLine($"Функция Аккермана = {Akkerman(m, n)}");
